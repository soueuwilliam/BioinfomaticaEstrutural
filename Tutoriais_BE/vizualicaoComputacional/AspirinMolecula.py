...
def restoreCoreModels():
	...
	atomInfo = cPickle.loads(base64.b64decode(''))
	bondInfo = cPickle.loads(base64.b64decode(''))
	crdInfo = cPickle.loads(base64.b64decode(''))
...
u'Au': ((1, 0.819608, 0.137255), 1, u'default'), u'At': ((0.458824, 0.309804, 0.270588), 1, u'default'), u'In': ((0.65098, 0.458824, 0.45098), 1, u'default')}
	...
	modelAssociations = {}
	colorInfo = (6, (u'H', (1, 1, 1, 1)), {(u'green', (0, 1, 0, 1)): [5], (u'O', (1, 0.0509804, 0.0509804, 1)): [1], (u'tan', (0.823529, 0.705882, 0.54902, 1)): [0], (u'yellow', (1, 1, 0, 1)): [4], (u'C', (0.564706, 0.564706, 0.564706, 1)): [3]})
	viewerInfo = {'cameraAttrs': {'center': (0.19655002384186, -0.3522, -0.3068), 'fieldOfView': 7.9489612996301, 'nearFar': (5.0272518547204, -5.6408518547204), 'ortho': False, 'eyeSeparation': 50.8, 'focal': -0.3068}, 'viewerAttrs': {'silhouetteColor': None, 'clipping': False, 'showSilhouette': False, 'showShadows': False, 'viewSize': 11.832807394958, 'labelsOnTop': True, 'depthCueRange': (0.5, 1), 'silhouetteWidth': 2, 'singleLayerTransparency': True, 'shadowTextureSize': 2048, 'backgroundImage': [None, 1, 2, 1, 0, 0], 'backgroundGradient': [('Chimera default', [(1, 1, 1, 1), (0, 0, 1, 1)], 1), 1, 0, 0], 'depthCue': True, 'highlight': 0, 'scaleFactor': 0.66807065202237, 'angleDependentTransparency': True, 'backgroundMethod': 0}, 'viewerHL': 5, 'cameraMode': 'mono', 'detail': 1.5, 'viewerFog': None, 'viewerBG': None}
...
def restoreRemainder():
	...
	windowSize = (1366, 595)
	xformMap = {0: (((-0.61160315989276, 0.14265116807846, -0.77819805901521), 58.836625390486), (0.38697493366022, 0.11680061092286, -0.28272153354363), True)}
	fontInfo = {'face': ('Sans Serif', 'Normal', 16)}
	clipPlaneInfo = {}
	silhouettes = {0: True, 44: True}
